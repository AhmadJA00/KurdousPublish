...
const TranslatorsPages = () => {
  return (
    <section
      className={`flex flex-col justify-around items-start px-2 md:px-24 pt-28 lg:pt-36 bg-light-primary dark:bg-dark-primary `}
    >
      <div className="flex flex-col justify-start items-center mt-14">
        <div>
          <h1
            className={`uppercase text-light-secondary dark:text-dark-secondary font-extrabold text-3xl group relative cursor-pointer`}
          >
            وەرگێڕەکان
          </h1>
        </div>
